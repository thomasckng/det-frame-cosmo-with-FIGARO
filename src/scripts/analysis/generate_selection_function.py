...
from cbc_pdet.o123_class_found_inj_general import Found_injections # from https://github.com/sterinaldi/cbc_pdet
...
with open(paths.data / 'selection_function.pkl', 'wb') as f:
