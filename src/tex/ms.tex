...
\abstract{
    ...
    We tested our method with mock data and applied it to the real data from the LIGO-Virgo-KAGRA Collaboration.
}
...
Other studies have made use of non-parametric methods with the spectral-siren framework \citep{Mandel:2018mve, Tiwari:2020vym, Rinaldi:2021bhm, Edelman:2021zkw, Sadiq:2021fin, Edelman:2022ydv, Callister:2023tgi, Ray:2023upk}.
...
\begin{figure}[htbp]
    ...
    \caption{
        ...
        The off-diagonal contour plots show the joint distributions, where the contours represent the 39.35\% and 90\% credible intervals.
...
\begin{table}[htbp]
    \caption{Fixed parameters of the $\Lambda$CDM model (upper) and the \textsc{power law + peak} model (lower)}
    \begin{tabular}{cc}
        \toprule
        Parameter & Value \\
        \midrule
        ...
        $m_\mathrm{min}$ & $5.0808821331157095$ \\
        $m_\mathrm{max}$ & $109.03299036617125$ \\
...
The result of the remapping is shown in Fig.~\ref{fig:real_result_multi}.
\begin{figure}[htbp]
...
This analysis is a proof of concept of our method.
We aim to demonstrate that our method can be applied to the real data.
To perform a detailed analysis, a more comprehensive configuration that considers different population models, cosmological models, and selection functions is required.
If a wrong population model is chosen, the result will be biased \citep{Mukherjee:2021rtw, Mastrogiovanni:2021wsd, Pierra:2023deu, LIGOScientific:2020kqk, KAGRA:2021duu}.
