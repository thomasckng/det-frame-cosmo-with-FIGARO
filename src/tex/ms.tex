...
In this section, we apply our method to the \ac{GW} events released by the \ac{LVK} as part of the GWTC-2.1 \cite{LIGOScientific:2021usb} and GWTC-3 \cite{KAGRA:2021vkt} catalogs.
